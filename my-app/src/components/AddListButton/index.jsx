...
export const AddListButton = ({colors, onAdd}) => {
...
const onClose = () => {
    ...
    return (
        <div className="add_list">
            ...
            {visiblePopup && <div className="add_list-popup">
                <svg className="add_list-popup-close-btn" onClick={onClose} width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" alt='x'>
                ...
                <input value={inputValue} onChange={event => setInputValue(event.target.value)} className="field" type="text" placeholder="Название списка" />
                <div className="add_list-popup_colors">
